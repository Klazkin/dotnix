...

{
  ...
  programs.vscode = {
      ...
      userSettings = {
        ...
        "workbench.colorTheme" = lib.mkForce "Gruvbox Material Dark"; # overwrites stylix theme
  ...
  dconf = {
      ...
      settings = {
          ...
          "org/gnome/shell/extensions/blur-my-shell" = {
            hacks-level = 1;
            pipelines = "{'pipeline_default': {'name': <'Default'>, 'effects': <[<{'type': <'native_static_gaussian_blur'>, 'id': <'effect_04658137160128'>, 'params': <{'unscaled_radius': <20>, 'brightness': <0.69999999999999996>}>}>]>}, 'pipeline_98317024624478': {'name': <'FullBright'>, 'effects': <[<{'type': <'native_static_gaussian_blur'>, 'id': <'effect_04908479552873'>, 'params': <{'unscaled_radius': <20>, 'brightness': <1>}>}>]>}}";
            settings-version = 2;
          };
		  ...
		  "org/gnome/desktop/screensaver" = {
		        picture-uri = "file:///home/matpac/.local/share/backgrounds/2025-01-23-21-05-42-wallpaper.jpg";
		        primary-color = "#3465a4";show-cpu = false;
      show-download = true;
      show-memory = false;
      show-swap = false;
      show-upload = false;
